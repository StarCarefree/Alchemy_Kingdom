...
public class Ruins extends Projectile {

    public Ruins(EntityType<? extends Ruins> p_37248_, Level p_37249_) {
        super(p_37248_, p_37249_);
        this.getPersistentData().putInt("deadtick",20*15);
    }
    public static Ruins createInstance(PlayMessages.SpawnEntity packet, Level worldIn) {
        return new Ruins(AKEntiteRegristrys.RuinsS,worldIn);
    }
