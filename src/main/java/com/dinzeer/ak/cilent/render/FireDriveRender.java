...
@OnlyIn(Dist.CLIENT)
public class FireDriveRender<T extends EntityAbstractSummonedSword> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURE = AlchemyKingdom.prefix("model/util/kungunier_texture.png");
    private static final ResourceLocation MODEL = AlchemyKingdom.prefix("model/util/moondrive.obj");
    ...
    public FireDriveRender(EntityRendererProvider.Context context) {
        super(context);
    }
