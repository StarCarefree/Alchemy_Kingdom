...
@OnlyIn(Dist.CLIENT)
public class KungunierRender<T extends EntityAbstractSummonedSword> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURE = AlchemyKingdom.prefix("model/util/kungunier_texture.png");
    private static final ResourceLocation MODEL = AlchemyKingdom.prefix("model/util/kungunier_drive.obj");
    ...
    public KungunierRender(EntityRendererProvider.Context context) {
        super(context);
    }
