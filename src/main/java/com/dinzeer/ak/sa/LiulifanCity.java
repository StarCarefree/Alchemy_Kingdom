...
public class LiulifanCity {
    public static void doSlash(LivingEntity playerIn){
        ...
        if (!_entfound.stream().filter(e -> e instanceof com.dinzeer.ak.entity.LiuliFanCity liuliFanCity && liuliFanCity.getOwner() == playerIn).toList().isEmpty()){
            return;
        }
        com.dinzeer.ak.entity.LiuliFanCity shivaDance = new com.dinzeer.ak.entity.LiuliFanCity(AKEntiteRegristrys.LC, level);
