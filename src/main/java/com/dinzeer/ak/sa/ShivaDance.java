...
public class ShivaDance {
    public static void doSlash(LivingEntity playerIn){
        ...
        if (!_entfound.stream().filter(e -> e instanceof com.dinzeer.ak.entity.ShivaDance shivaDance && shivaDance.getOwner() == playerIn).toList().isEmpty()){
            return;
        }
        com.dinzeer.ak.entity.ShivaDance shivaDance = new com.dinzeer.ak.entity.ShivaDance(AKEntiteRegristrys.SD, level);
