...
public class TheEmperorofIce extends Projectile {

    public TheEmperorofIce(EntityType<? extends TheEmperorofIce> p_37248_, Level p_37249_) {
        super(p_37248_, p_37249_);
        this.getPersistentData().putInt("deadtick",20*15);
    }
    public static TheEmperorofIce createInstance(PlayMessages.SpawnEntity packet, Level worldIn) {
        return new TheEmperorofIce(AKEntiteRegristrys.TheEmperorofIceS,worldIn);
    }
    ...
    public void tick() {
        if (this.level() instanceof ServerLevel level) {
            ...
            if (owner != null) {
                orbitAroundEntity(this, owner, 6, 0.5f);
            }
            sendParticleCircleN(level, new Vec3(pos.x,pos.y+1,pos.z), ParticleTypes.SNOWFLAKE, 2, 6);
                ...
                if (entityiterator != this) {
                    if (entityiterator != owner) {
                        if (entityiterator instanceof LivingEntity livingEntity) {
                            ...
                            livingEntity.addEffect(new MobEffectInstance(MobEffects.WEAKNESS, 60, 5, (false), (false)));
                            livingEntity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 60, 5, (false), (false)));
                            livingEntity.addEffect(new MobEffectInstance(AlchemyKingdom.EffectAbout.Ice.get(), 60, 5, (false), (false)));
