                ...
                ComboState.Builder.newInstance().startAndEnd(400, 459).priority(50)
                        ...
                        .addTickAction(ComboState.TimeLineTickAction.getBuilder()
                                .put(2, (entityIn) -> AttackManager.doSlash(entityIn, -30F, Vec3.ZERO, false, false
                                        , 1))
                                .put(3, (entityIn) -> FireSlash.doSlash(entityIn, 90F, 20, Vec3.ZERO, false, 15, 3f, 3f, 2, 16711680)).build())
        ...
        DragonS= COMBO_STATES.register("dragon",
                ComboState.Builder.newInstance().startAndEnd(459, 488).priority(50)
                        ...
                        .addTickAction(ComboState.TimeLineTickAction.getBuilder()
                                .put(2, (entityIn) -> AttackManager.doSlash(entityIn, -30F, Vec3.ZERO, false, false
                                        , 1))
                                .put(3,(entityIn) -> Dragon.doSlash(entityIn, 0, 20, Vec3.ZERO, false, 30, 1f, 2f, 2, 16711680))
                                .put(4,(entityIn) -> Dragon.doSlash(entityIn, 0, 20, Vec3.ZERO, false, 30, 1f, 2f, 1, 0))
                                .put(5,(entityIn) -> Dragon.doSlash(entityIn, 0, 20, Vec3.ZERO, false, 30, 1f, 2f, 1, 0))
                                .put(6,(entityIn) -> Dragon.doSlash(entityIn, 0, 20, Vec3.ZERO, false, 30, 1f, 2f, 1, 0))
                                .build())
                        .addHitEffect(StunManager::setStun)
                        ::build);
