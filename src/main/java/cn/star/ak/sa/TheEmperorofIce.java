...
public class TheEmperorofIce {
    public static void doSlash(LivingEntity playerIn){
        ...
        if (!_entfound.stream().filter(e -> e instanceof cn.star.ak.entity.TheEmperorofIce theEmperorofIce && theEmperorofIce.getOwner() == playerIn).toList().isEmpty()){
            return;
        }
        cn.star.ak.entity.TheEmperorofIce shivaDance = new cn.star.ak.entity.TheEmperorofIce(AKEntiteRegristrys.TheEmperorofIceS, level);
