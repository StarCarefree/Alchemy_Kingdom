...
public class EntityPointer {
    ...
    public static HitResult raycast(Level level, Vec3 startVec, Vec3 endVec, boolean checkForBlocks) {
    ...
    public static boolean isOnRay(Vec3 startVec, Vec3 endVec, Vec3 point) {
